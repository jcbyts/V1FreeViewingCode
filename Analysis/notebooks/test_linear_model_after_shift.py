...
#% This is optional
"""
Fit DivNorm model with shifter 3 times.
"""
for version in range(22,25): # range of version numbers
...
LLspace = gd.get_ll_by_eyepos(model, lldict=lldict, use_stim=0) # gabor only
