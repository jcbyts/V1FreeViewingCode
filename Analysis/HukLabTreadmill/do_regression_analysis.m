...
sp = struct('st', D.spikeTimes, 'clu', D.spikeIds, 'cids', unique(D.spikeIds));
...
[ridgeVals, dimBeta, convergenceFailures] = ridgeMML(Robs(good_inds,:), fullR(good_inds,reg_inds), true); %get ridge penalties and beta weights.
