function [mae, stimhat, yhat, wts, gfun] = von_mises_decoder(R, stim, iitrain, iitest, varargin)
...
gfun = decoding.vm_basis_deg(nBasis, ip.Results.Beta, false);
...
xd = 0:359; % basis will be interpolated over these values
B = gfun(xd);
